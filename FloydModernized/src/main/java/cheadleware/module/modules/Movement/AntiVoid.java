...
import cheadleware.events.PlayerUpdateEvent;
import cheadleware.module.Module;
import cheadleware.util.PlayerUtil;
import cheadleware.util.RandomUtil;
...
public class AntiVoid extends Module {
    ...
    private void resetBlink() {
        Cheadleware.blinkManager.setBlinkState(false, BlinkModules.ANTI_VOID);
