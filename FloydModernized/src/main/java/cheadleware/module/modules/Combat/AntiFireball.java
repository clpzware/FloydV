package cheadleware.module.modules;
    ...
    public void onUpdate(UpdateEvent event) {
        if (this.isEnabled() && event.getType() == EventType.PRE) {
            ...
            if (TeamUtil.isEntityLoaded(fireball)) {
                ...
                if (!Cheadleware.playerStateManager.attacking && !Cheadleware.playerStateManager.digging && !Cheadleware.playerStateManager.placing) {
