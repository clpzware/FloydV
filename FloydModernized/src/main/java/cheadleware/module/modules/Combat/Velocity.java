        ...
        if (event.getType() == EventType.POST) {
            if (this.reverseFlag
                    ...
                    this.canDelay()
                            ...
                            || Cheadleware.delayManager.isDelay() >= (long) this.delayTicks.getValue()
            )) {
                Cheadleware.delayManager.setDelayState(false, DelayModules.VELOCITY);
                ...
                if (packet.getEntityID() == mc.thePlayer.getEntityId()) {
                    ...
                    if (this.mode.getValue() == 2
                        ...
                        if (this.delayChanceCounter >= 100) {
                            Cheadleware.delayManager.setDelayState(true, DelayModules.VELOCITY);
