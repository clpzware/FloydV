        ...
        if (this.isEnabled()) {
            if (this.blockCounter.getValue()) {
                ...
                mc.fontRendererObj.drawString(
                        ...
                        (float) new ScaledResolution(mc).getScaledWidth() / 2.0F + (float) mc.fontRendererObj.FONT_HEIGHT * 1.5F,
                        (float) new ScaledResolution(mc).getScaledHeight() / 2.0F - (float) mc.fontRendererObj.FONT_HEIGHT / 2.0F + 1.0F,
