package fr.ambient.util.waveycapes.sim;
...
import fr.ambient.util.waveycapes.util.Mth;
...
public class StickSimulation {
    ...
    public float gravity = Ambient.getInstance().getModuleManager().getModule(Cosmetics.class).gravity.getValue();
    public int numIterations = Ambient.getInstance().getModuleManager().getModule(Cosmetics.class).numIterations.getValue().intValue();
    private float maxBend = Ambient.getInstance().getModuleManager().getModule(Cosmetics.class).maxBend.getValue();

    public void simulate() {
        gravity = Ambient.getInstance().getModuleManager().getModule(Cosmetics.class).gravity.getValue();
        numIterations = Ambient.getInstance().getModuleManager().getModule(Cosmetics.class).numIterations.getValue().intValue();
        maxBend = Ambient.getInstance().getModuleManager().getModule(Cosmetics.class).maxBend.getValue();
