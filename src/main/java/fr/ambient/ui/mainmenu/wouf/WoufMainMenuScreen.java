...
public class WoufMainMenuScreen extends GuiScreen {
    ...
    private final List<MainMenuSecondaryButton> secondaryButtons = Arrays.asList(
            new MainMenuSecondaryButton(ButtonType.ALTMANAGER, () -> mc.displayGuiScreen(new GuiAltManager(this))),
    ...
    public void initGui() {
        Ambient.getInstance().getDiscordRP().update(Ambient.getInstance().getUsername() + " [" + Ambient.getInstance().getUid() + "]","Main Menu");
    ...
    private void openFileChooser() {
        ...
        if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            mc.addScheduledTask(() -> {
                ...
                Ambient.getInstance().getConfig().setValue("wallpaper", selectedFile.getAbsolutePath());
