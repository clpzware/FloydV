...
public class Vec3 {
    ...
    public Vec3(Entity e){
        this(e.posX, e.posY + e.getEyeHeight(), e.posZ);
    }
    ...
    public Vec3 interpolateWith(Vec3 other, float partial){

        return new Vec3(
                other.xCoord + (this.xCoord - other.xCoord) * partial,
                other.yCoord + (this.yCoord - other.yCoord) * partial,
                other.zCoord + (this.zCoord - other.zCoord) * partial
        );
