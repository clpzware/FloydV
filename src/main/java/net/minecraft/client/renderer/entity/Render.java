...
import fr.ambient.module.impl.render.player.NameTags;
...
public abstract class Render<T extends Entity> implements IEntityRenderer {
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
        ...
        if(Ambient.getInstance().getModuleManager().getModule(NameTags.class).isEnabled() &&
        Ambient.getInstance().getModuleManager().getModule(NameTags.class).isValid(entityIn)){
            return;
        }
