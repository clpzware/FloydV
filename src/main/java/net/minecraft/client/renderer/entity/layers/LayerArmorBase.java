...
public abstract class LayerArmorBase<T extends ModelBase> implements LayerRenderer<EntityLivingBase> {
    ...
    private void renderLayer(EntityLivingBase entitylivingbaseIn, float p_177182_2_, float p_177182_3_, float partialTicks, float p_177182_5_, float p_177182_6_, float p_177182_7_, float scale, int armorSlot) {
        ...
        if(Ambient.getInstance().getModuleManager().getModule(PlayerRender.class).isEnabled() && Ambient.getInstance().getModuleManager().getModule(PlayerRender.class).noarmor.getValue()){
            return;
        }
        ...
        if (itemstack != null && itemstack.getItem() instanceof ItemArmor itemarmor) {
            ...
            if (ESP.renderGlint && !this.skipRenderGlint && itemstack.isItemEnchanted() && (!Config.isCustomItems() || !CustomItems.renderCustomArmorEffect(entitylivingbaseIn, itemstack, t, p_177182_2_, p_177182_3_, partialTicks, p_177182_5_, p_177182_6_, p_177182_7_, scale))) {
