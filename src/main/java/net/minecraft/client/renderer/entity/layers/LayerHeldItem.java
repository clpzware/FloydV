...
public class LayerHeldItem implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale) {
        ...
        if (itemstack != null) {
            ...
            if (Minecraft.getMinecraft().thePlayer != null && (((mc.thePlayer.isBlocking() && itemstack.getItem() instanceof ItemSword) || !Ambient.getInstance().getModuleManager().getModule(KillAura.class).targetList.isEmpty() && itemstack.getItem() instanceof ItemSword)) && entitylivingbaseIn == Minecraft.getMinecraft().thePlayer) {
