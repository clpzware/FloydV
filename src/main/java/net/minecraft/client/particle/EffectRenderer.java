...
public class EffectRenderer {
    ...
    private void registerVanillaParticles() {
        ...
        this.registerParticle(EnumParticleTypes.BLOOD_PARTICLE.getParticleID(), new EntityBreakingFX.BloodFactory());
        this.registerParticle(EnumParticleTypes.CUSTOM_PARTICLE.getParticleID(), new EntityBreakingFX.BloodFactory());
    }
