...
public class ServerList {
    ...
    public void loadServerList() {
        try {
            this.servers.clear();
            final NBTTagCompound nbttagcompound = CompressedStreamTools.read(new File(this.mc.mcDataDir + (GuiMultiplayer.usingFinderList ? "/" + Floyd.NAME : ""), "servers.dat"));
    ...
    public void saveServerList() {
        try {
            ...
            CompressedStreamTools.safeWrite(nbttagcompound, new File(this.mc.mcDataDir + (GuiMultiplayer.usingFinderList ? "/" + Floyd.NAME : ""), "servers.dat"));
        } catch (final Exception exception) {
