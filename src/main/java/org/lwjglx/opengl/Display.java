...
//		Display.drawable = drawable;
	...
	public static void setFullscreen(boolean fullscreen) throws LWJGLException {
		...
		if(fullscreen){
			...
			glfwSetWindowSize(Window.handle, glfwVidMode.width(), glfwVidMode.height());
			glfwSetWindowPos(Window.handle, 0, 0);
		}else{
			glfwSetWindowAttrib(Window.handle, GLFW_DECORATED, GLFW_TRUE);
			glfwSetWindowMonitor(Window.handle, 0,
					displayX + displayWidth / 2 - mode.getWidth() / 2,
					displayY + displayHeight / 2 - mode.getHeight() / 2,
