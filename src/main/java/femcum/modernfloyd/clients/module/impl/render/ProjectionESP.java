...
import static femcum.modernfloyd.clients.util.render.RenderUtil.*;
        ...
        for (EntityLivingBase player : entitys) {
            ...
            Runnable runnable = () -> {
                ...
                if (this.moggage.getValue()) {
                    RenderUtil.image(new ResourceLocation("floyd/images/Alan.png"), pos.x + 2, pos.y + 2, pos.z - pos.x - 3, pos.w - pos.y - 3, Color.WHITE);
                }
