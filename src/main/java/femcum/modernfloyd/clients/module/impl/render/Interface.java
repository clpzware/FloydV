...
import femcum.modernfloyd.clients.module.impl.render.interfaces.CreidaInterface;
import femcum.modernfloyd.clients.module.impl.render.interfaces.ExhibitionInterface;
import femcum.modernfloyd.clients.module.impl.render.interfaces.ModernInterface;
import femcum.modernfloyd.clients.module.impl.render.interfaces.WurstInterface;
...
public final class Interface extends Module {
    ...
    public void createArrayList() {
        ...
        Floyd.INSTANCE.getModuleManager().getAll().stream()
...
//        Floyd.INSTANCE.getModuleManager().getAll().forEach(module -> components.add(new ModuleComponent(module)));
//
