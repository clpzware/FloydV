...
import femcum.modernfloyd.clients.util.pathfinding.unlegit.MainPathFinder;
import femcum.modernfloyd.clients.util.pathfinding.unlegit.Vec3;
...
public final class TeleportAura extends Module {
    ...
    private void attack(EntityLivingBase target) {
        ...
        if (ViaLoadingBase.getInstance().getTargetVersion().olderThanOrEqualTo(ProtocolVersion.v1_8)) {
            Floyd.INSTANCE.getEventBus().handle(new ClickEvent());
