...
import femcum.modernfloyd.clients.event.impl.other.*;
import femcum.modernfloyd.clients.event.impl.motion.*;
import femcum.modernfloyd.clients.event.impl.other.*;
...
import femcum.modernfloyd.clients.util.pathfinding.custom.PathFinder;
...
import femcum.modernfloyd.clients.value.impl.CurveValue;
...
import static femcum.modernfloyd.clients.module.impl.other.data.Equations.EUCLIDEAN_DISTANCE;
...
//        Floyd.INSTANCE.getBotManager().add(this, otherEntity);
...
//            }
//
////            Floyd.INSTANCE.getModuleManager().get(c).getClass().getClassLoader().getClass().getDeclaredMethod("defineClass", String.class, byte[].class, int.class, int.class)
////                    .invoke(Floyd.INSTANCE.getModuleManager().get(c).getClass().getClassLoader(), c.getName(), byteArray, 0, byteArray.length);
//
...
//            defineClass.invoke(Floyd.INSTANCE.getModuleManager().get(c).getClass().getClassLoader(), c.getName(), byteArray, 0, byteArray.length);
