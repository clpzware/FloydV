...
import femcum.modernfloyd.clients.module.impl.movement.flight.deprecated.ACRFlight;
import femcum.modernfloyd.clients.module.impl.movement.flight.deprecated.DamageFlight;
    ...
    public final Listener<Render3DEvent> onRender3D = event -> {
        if (dragon.getValue()) {
            if (entityDragon == null) {
                ...
                Floyd.INSTANCE.getBotManager().add(this, entityDragon);
            }
