package femcum.modernfloyd.clients.component.impl.hud;

import femcum.modernfloyd.clients.Floyd;
import femcum.modernfloyd.clients.component.Component;
import femcum.modernfloyd.clients.component.impl.hud.dragcomponent.api.Orientation;
import femcum.modernfloyd.clients.component.impl.hud.dragcomponent.api.Snap;
...
import static femcum.modernfloyd.clients.util.animation.Easing.LINEAR;
    ...
    public final Listener<Render2DEvent> onRender2D = event -> {
        try {
            ...
            if (selectedValue != null) {
                ...
                double edgeSnap = Floyd.INSTANCE.getThemeManager().getTheme().getPadding();
            ...
            for (Module module : modules) {
                ...
                float offset = Floyd.INSTANCE.getThemeManager().getTheme().getPadding();
