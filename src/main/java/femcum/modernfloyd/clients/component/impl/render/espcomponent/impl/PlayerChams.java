package femcum.modernfloyd.clients.component.impl.render.espcomponent.impl;

import femcum.modernfloyd.clients.Floyd;
import femcum.modernfloyd.clients.component.impl.render.espcomponent.api.ESP;
...
public class PlayerChams extends ESP implements Accessor {
    ...
    public void render3D() {
        boolean staticColor = Floyd.INSTANCE.getModuleManager().get(femcum.modernfloyd.clients.module.impl.render.ESP.class).staticColorESP.getValue();
