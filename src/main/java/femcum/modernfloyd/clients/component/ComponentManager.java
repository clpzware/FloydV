package femcum.modernfloyd.clients.component;

import femcum.modernfloyd.clients.Floyd;
import femcum.modernfloyd.clients.component.impl.event.EntityKillEventComponent;
import femcum.modernfloyd.clients.component.impl.event.EntityTickComponent;
import femcum.modernfloyd.clients.component.impl.event.MouseEventComponent;
import femcum.modernfloyd.clients.component.impl.hud.AdaptiveRefreshRateComponent;
import femcum.modernfloyd.clients.component.impl.hud.DragComponent;
import femcum.modernfloyd.clients.component.impl.hypixel.APIKeyComponent;
import femcum.modernfloyd.clients.component.impl.packetlog.PacketLogComponent;
import femcum.modernfloyd.clients.component.impl.patches.GuiClosePatchComponent;
import femcum.modernfloyd.clients.component.impl.performance.ParticleDistanceComponent;
import femcum.modernfloyd.clients.component.impl.player.*;
import femcum.modernfloyd.clients.component.impl.render.*;
import femcum.modernfloyd.clients.component.impl.viamcp.*;
...
//        this.add(new Translation());
        ...
        this.componentList.forEach((componentClass, component) -> Floyd.INSTANCE.getEventBus().register(component));
