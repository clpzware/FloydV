package femcum.modernfloyd.clients.script;

import femcum.modernfloyd.clients.Floyd;
import femcum.modernfloyd.clients.script.util.ScriptHandler;
import lombok.Data;
...
public final class Script {
    ...
    public void load() throws ScriptException {
        try {
            ...
            this.engine = Floyd.INSTANCE.getScriptManager().createEngine();
