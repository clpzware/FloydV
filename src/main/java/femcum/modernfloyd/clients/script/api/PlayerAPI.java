...
import femcum.modernfloyd.clients.component.impl.player.ItemDamageComponent;
...
import femcum.modernfloyd.clients.script.api.wrapper.impl.ScriptInventory;
import femcum.modernfloyd.clients.script.api.wrapper.impl.ScriptItemStack;
...
public class PlayerAPI extends ScriptEntityLiving {
    ...
    public void setHeldItem(int slot, boolean render) {
        Floyd.INSTANCE.getComponentManager().get(Slot.class).setSlot(slot);
    }
    ...
    public ScriptItemStack getHeldItemStack() {
        return new ScriptItemStack(Floyd.INSTANCE.getComponentManager().get(Slot.class).getItemStack());
    }
