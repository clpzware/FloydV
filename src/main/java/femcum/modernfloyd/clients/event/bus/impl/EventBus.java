package femcum.modernfloyd.clients.event.bus.impl;

import femcum.modernfloyd.clients.Floyd;
import femcum.modernfloyd.clients.event.Listener;
import femcum.modernfloyd.clients.event.annotations.EventLink;
import femcum.modernfloyd.clients.event.bus.Bus;
...
public final class EventBus<Event> implements Bus<Event>, Accessor {
            ...
            for (final Field field : subscriber.getClass().getDeclaredFields()) {
                ...
                if (annotation != null) {
                    ...
                    try {
                        ...
                        if (!Floyd.DEVELOPMENT_SWITCH) return;
    ...
    public void handle(final Event event) {
        try {
            if ((mc.theWorld == null || mc.getNetHandler() == null || (!mc.getNetHandler().doneLoadingTerrain && !(event instanceof PacketSendEvent))) && !(event instanceof RenderGUIEvent || event instanceof ServerKickEvent || event instanceof GameEvent || event instanceof WorldChangeEvent || event instanceof ServerJoinEvent)) {
                return;
            }
