        ...
        if (!sizes.containsKey(key)) {
            ...
            if (name.contains(":")) {
                ...
                for (String alias : weight.getAliases()) {
                    location = "floyd/font/" + String.format(name, alias) + "." + extention;
