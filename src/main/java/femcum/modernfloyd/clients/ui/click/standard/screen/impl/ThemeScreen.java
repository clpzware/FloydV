...
import femcum.modernfloyd.clients.ui.click.standard.components.theme.ThemeComponent;
import femcum.modernfloyd.clients.ui.click.standard.components.theme.ThemeKeyColorComponent;
    ...
    public void onClick(int mouseX, int mouseY, int mouseButton) {
        ...
        for (ThemeComponent theme : this.visibleThemes) {
            if (GUIUtil.mouseOver(theme.getLastDraw().getX(), theme.getLastDraw().getY(), theme.getLastDraw().getZ(), 50, mouseX, mouseY)) {
                Floyd.INSTANCE.getThemeManager().setTheme(theme.getActiveTheme());
            }
        }
