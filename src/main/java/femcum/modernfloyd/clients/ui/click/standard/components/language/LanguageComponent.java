package femcum.modernfloyd.clients.ui.click.standard.components.language;
...
public class LanguageComponent implements Accessor {
    ...
    public void draw(double y) {
        ...
        Fonts.MAIN.get(20, Weight.REGULAR).draw(this.englishName, position.getX() + sidebar + 18, position.getY() + y + 9,
                Floyd.INSTANCE.getLocale().equals(this.locale) ? getTheme().getAccentColor(new Vector2d(0, position.y / 5)).getRGB() :
                        Colors.TEXT.getRGB());
        ...
        // Draw flag
        RenderUtil.image(new ResourceLocation("floyd/icons/language/" + locale.getFile() + ".png"),
    ...
    public void click(double mouseX, double mouseY) {
        ...
        if (GUIUtil.mouseOver(position.getX() + sidebar + 8, position.getY() + lastY,
            ...
            Floyd.INSTANCE.setLocale(this.locale);
