package femcum.modernfloyd.clients.ui.menu.impl.account;
...
import femcum.modernfloyd.clients.ui.menu.impl.account.display.AccountViewModel;
import femcum.modernfloyd.clients.ui.menu.impl.account.impl.AddAccountScreen;
...
import femcum.modernfloyd.clients.util.render.ScissorUtil;
...
public class AccountManagerScreen extends GuiScreen implements Accessor {
    private static final AltManager ALT_MANAGER = Floyd.INSTANCE.getAltManager();
