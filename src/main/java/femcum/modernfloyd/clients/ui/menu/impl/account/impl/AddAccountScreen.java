package femcum.modernfloyd.clients.ui.menu.impl.account.impl;
...
import femcum.modernfloyd.clients.ui.menu.component.button.impl.MenuAccountTypeButton;
...
public class AddAccountScreen extends GuiScreen implements Accessor {
    ...
    private static final ResourceLocation XBOX_RESOURCE = new ResourceLocation("floyd/images/xbox.png");
    private static final ResourceLocation MICROSOFT_RESOURCE = new ResourceLocation("floyd/images/microsoft.png");
    private static final ResourceLocation CRACKED_RESOURCE = new ResourceLocation("floyd/images/minecraft.png");
    private static final ResourceLocation COOKIE_RESOURCE = new ResourceLocation("floyd/images/Cookie.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Floyd.DEVELOPMENT_SWITCH) mc.fontRendererObj.drawWithShadow(Minecraft.getDebugFPS() + "", 0, 0, -1);
