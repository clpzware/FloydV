package femcum.modernfloyd.clients.util.shader;
...
public class ShaderUtil implements Accessor {
    ...
    public static String getShaderResource(final String resource) {
        try {
            final InputStream inputStream = RESOURCE_MANAGER.getResource(new ResourceLocation("floyd/shader/" + resource)).getInputStream();
