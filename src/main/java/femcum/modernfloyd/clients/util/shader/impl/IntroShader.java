package femcum.modernfloyd.clients.util.shader.impl;

import femcum.modernfloyd.clients.util.shader.base.RiseShader;
import femcum.modernfloyd.clients.util.shader.base.RiseShaderProgram;
import femcum.modernfloyd.clients.util.shader.base.ShaderRenderType;
import femcum.modernfloyd.clients.util.shader.base.ShaderUniforms;
...
public class IntroShader extends RiseShader {

    private final RiseShaderProgram program = new RiseShaderProgram("main_menu/intro.frag", "vertex.vsh");
