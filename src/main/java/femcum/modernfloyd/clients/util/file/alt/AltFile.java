package femcum.modernfloyd.clients.util.file.alt;

import femcum.modernfloyd.clients.Floyd;
import femcum.modernfloyd.clients.util.account.Account;
import femcum.modernfloyd.clients.util.account.AccountType;
...
public class AltFile extends femcum.modernfloyd.clients.util.file.File {
    ...
    public boolean read() {
        ...
        try {
            ...
            List<Account> accounts = Floyd.INSTANCE.getAltManager().getAccounts();
            accounts.clear();
