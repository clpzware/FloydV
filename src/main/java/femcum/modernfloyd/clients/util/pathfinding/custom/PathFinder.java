package femcum.modernfloyd.clients.util.pathfinding.custom;

import femcum.modernfloyd.clients.util.Accessor;
import femcum.modernfloyd.clients.util.chat.ChatUtil;
import femcum.modernfloyd.clients.util.pathfinding.custom.api.Map;
import femcum.modernfloyd.clients.util.pathfinding.custom.api.Path;
import femcum.modernfloyd.clients.util.pathfinding.custom.api.Point;
import femcum.modernfloyd.clients.util.pathfinding.custom.api.Rules;
import femcum.modernfloyd.clients.util.process.ThreadUtil;
...
import static femcum.modernfloyd.clients.util.pathfinding.custom.api.Rules.COLLISIONS;
import static femcum.modernfloyd.clients.util.pathfinding.custom.api.Rules.LEGIT;
