package femcum.modernfloyd.clients.util.localization;
...
public class Localization {
    ...
    /**
     * Gets a translated string using the Floyd's current locale
     *
     * @param key The key of the string to translate
     * @return The translated string of the key, using the Floyd's current locale
     */
    public static String get(String key) {
        return get(key, Floyd.INSTANCE.getLocale());
    }
     ...
     * located in floyd/text
     */
    public static void populate() {
        for (Locale locale : Locale.values()) {
            ResourceLocation resourceLocation = new ResourceLocation("floyd/text/" + locale.getFile() + ".properties");
